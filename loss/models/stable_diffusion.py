...
class StableDiffusion(nn.Module):
    def __init__(self, device):
        ...
        # self.min_step = int(self.num_train_timesteps * 0.50)
        # self.max_step = int(self.num_train_timesteps * 0.60)
    ...
    def train_step(self, text_embeddings, pred_rgb, guidance_scale=100):
        ...
        return torch.tensor(0).to(self.device)# dummy loss value
...
if __name__ == '__main__':
    ...
    sd.prompt_to_img(opt.prompt, opt.H, opt.W, opt.steps)
